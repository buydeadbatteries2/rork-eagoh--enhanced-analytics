  ...
  if (tier === "free") {
    return (
      <View style={{ flex: 1, backgroundColor: pal.void, alignItems: "center", justifyContent: "center", padding: 32, gap: 18 }}>
        ...
        <View style={{ width: 72, height: 72, borderRadius: 36, borderWidth: 1, borderColor: "rgba(138,92,255,0.35)", backgroundColor: "rgba(138,92,255,0.08)", alignItems: "center", justifyContent: "center" }}>
          <Lock color={palette.violet} size={32} />
        </View>
        <Text style={{ color: palette.text, fontSize: 22, fontWeight: "900", letterSpacing: -0.5, textAlign: "center" }}>Faction Network Unavailable</Text>
        <Text style={{ color: palette.muted, fontSize: 14, fontWeight: "600", textAlign: "center", lineHeight: 20 }}>
          Upgrade to Pro, Oracle Elite, or Syndicate to access the Faction Network.
        </Text>
        <Pressable
